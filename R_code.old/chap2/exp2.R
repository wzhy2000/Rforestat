...
# 图形绘制及保存
# 绘制基础散点图
plot(forestData$Bio, forestData$H, main="Biomass vs Height", xlab="Biomass", ylab="Height")
...
ggplot(plot_1_filtered, aes(x, y = standing_stock)) +
    geom_boxplot() +
    labs(title = "Standing Stock by Age Group",
         x = "Age Group",
         y = "Standing Stock") +
...
table2excel(plot_1_filtered, file = "plot_1_filtered.xlsx", 
            digits = 4, digitspvals = 1, 
